...
ggsave(filename = paste0(graphs,"graph_eplT_tempA.pdf"), plot = last_plot(), height = 6, width = 9, units = "in")
...
ggsave(filename = paste0(graphs,"graph_eplP_tempA.pdf"), plot = last_plot(), height = 6, width = 9, units = "in")
...
ggsave(filename = paste0(graphs,"graph_eplG_tempA.pdf"), plot = last_plot(), height = 6, width = 9, units = "in")
